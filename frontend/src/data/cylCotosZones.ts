...
export const cylCotosZones: MushroomZone[] = [
  ...
  },
  {
    ...
    lng: -6.25,
    description:
      'Acotado Ribera de Cañedo (Salamanca) en el programa MicoCyL / MicologíaCyL. Montes y riberas del noroeste salmantino.',
    ...
    species: spp.mix,
    tips: [
      'Ficha en micocyl.es / MicologíaCyL',
  ...
  // ─── SEGOVIA ─────────────────────────────────────────────────────────────
  {
    ...
    lng: -4.05,
    description:
      'Acotado Montes de Segovia. Reconocimiento mutuo con montes de la Comunidad en Segovia en algunos permisos — confirma en la ficha actual de MicologíaCyL.',
    ...
    tips: [
      'Portal: micologiacyl.es / micocyl.es',
      'Valsaín y sierra: consulta también ENP Guadarrama',
    ],
  },
  {
    id: 'cyl-sg-montes-junta',
    name: 'Montes CyL en Segovia (Junta)',
    region: 'Castilla y León',
    provinces: ['Segovia'],
    lat: 41.12,
    lng: -3.95,
    description:
      'Montes de la Junta de Castilla y León en Segovia (acotado de la Comunidad). Permisos y reconocimiento mutuo con Montes de Segovia según campaña.',
  ...
  // ─── VALLADOLID ──────────────────────────────────────────────────────────
  {
    ...
    lng: -4.85,
    description:
      'Acotado VA-50001: Torozos, Mayorga y Pinares de Valladolid. Permisos para empadronados y generales según ficha MicologíaCyL.',
