...
Generated: `2026-07-17T12:21:40.820626+00:00`

## Executive summary

v9 offline: MAP@3=0.0700, top1=0.0482, genus=0.0760, ECE=0.0563. Lift over chance x48.2.

- Best T by ECE: **1.5** (ECE=0.0095, MAP@3=0.0700)
- Best open-set: conf≥0.1, margin≥0.02 → accept=24.33%, acc|accept=14.67%
- Deadly in test: {'n_deadly_in_test': 12, 'species_top1_accuracy_on_deadly': 0.0, 'any_deadly_in_top1': 0.0, 'any_deadly_in_topk': 0.0, 'k': 3, 'note': 'Safety: prefer high any_deadly_in_topk even if species wrong'}
- Zero-acc classes: 917

## Chance baselines

```json
{
  "uniform_top1": 0.0013901760889712697,
  "uniform_map3": 0.0023169601482854493,
  "frequency_prior_top1": 0.0013901760889712697,
  "frequency_prior_map3": 0.0025486561631139944,
  "random_top1": 0.0004633920296570899,
  "chance_1_over_C": 0.001,
  "model_lift_over_chance_top1": 48.19277108433735
}
```
